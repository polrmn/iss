...
type SharedType = { text: string, isArrow?: boolean, arrowDirection?: 'right' | 'down' }
...
export default function PrimaryElement(props: PrimaryProps) {
    const { element, text, isArrow = true, arrowDirection = 'right', ...nativeProps } = props;

    const Tag = ComponentMap[element] as ElementType;

    return (
        <Tag className={styles.primaryElement} {...nativeProps}>
